...
public class CarViewDetailsViewModel extends ViewModel {
    ...
    @Inject
    public CarViewDetailsViewModel(CarsRepository carsRepository) {
    ...
    public void restoreFromBundle(Bundle savedInstanceState) {
        if (selectedCar.getValue() == null) {
            if (savedInstanceState != null && savedInstanceState.containsKey("car_details")) {
